...
contract DecodingSample {
    ...
    struct S2 {
        uint256[2] structTwoFixedArrayUint;
        uint256[] structTwoDynamicArrayUint;
    }
    ...
    mapping(uint256 => uint256) varMapping;
    mapping(address => uint256) varAddressMapping;
    mapping(DecodingSample => uint256) varContractMapping;
    mapping(E => uint256) varEnumMapping;
    mapping(MyInt => MyInt) varWrapMapping;

    uint256 immutable immutableUint;

    uint256[2] fixedArrayUint;
    ...
    constructor() {
        ...
        varStructS.structS2.structTwoDynamicArrayUint = new uint256[](3);
        ...
        dynamicArrayUint = new uint256[](2);
    ...
    function spill() public view returns (uint256) {
